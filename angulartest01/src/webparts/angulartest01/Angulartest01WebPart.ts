...
import styles from './Angulartest01WebPart.module.scss';
import * as strings from 'Angulartest01WebPartStrings';

import * as angular from 'angular';
import './app/app-module';

export interface IAngulartest01WebPartProps {
  description: string;
}

export default class Angulartest01WebPartWebPart extends BaseClientSideWebPart<IAngulartest01WebPartProps> {
/*
  public render(): void {
